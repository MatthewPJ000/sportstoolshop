...
exports.getAllProducts = asyncWrapper(async (req, res) => {
  ...
  const products = [
    {
      _id: "6648b9e37a7ceb95a6e7f172",
      description: "This is description for the first.",
      name: "First",
      price: 100,
      images: [
        {
          url: "../../frontend/src/Image/products/bats/00001.jpg"
        }
      ], 
      ratings: 5,
      numOfReviews: 6
  ...
  res.status(201).json({
    ...
    productsCount: 8,
    resultPerPage: 6,
    filteredProductCount: 4,
  });
});

// >>>>>>>>>>>>> get all products from JSON >>>>>>>>>>>>>>>
exports.getAllProductsJSON = asyncWrapper(async (req, res) => {
  const products = [
    {
      _id: "6648b9e37a7ceb95a6e7f172",
      description: "This is description for the first.",
